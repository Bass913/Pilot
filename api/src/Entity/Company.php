...
class Company
{
    ...
    #[Groups(['read-company-details', 'read-company', 'read-booking','user:client:read:booking','user:employee:read:booking', 'user:read:company', 'add-company','update-company', 'read-schedule' ])]
