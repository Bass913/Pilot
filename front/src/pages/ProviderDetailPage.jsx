				...
				>
					<div>
						...
						<p className="text-gray-600 mt-2 flex gap-2 items-center font-light">
							...
							{provider.reviewRating} ({provider.reviewsCount}{" "}
							avis)
						</p>
					</div>
					...
					<div className="mt-8 flex flex-col lg:flex-row gap-8 w-full">
						<div className="w-full">
							<div>
								...
								<ServicesChooser services={provider.services} />
							...
							<div className="mt-10">
								...
								<CompanyReviews reviews={provider.reviews} />
							</div>
						</div>
						...
						<div className="w-full lg:w-132">
							...
							<CompanySchedule schedule={provider.schedule} />
						</div>
					</div>
				</div>
			)}
