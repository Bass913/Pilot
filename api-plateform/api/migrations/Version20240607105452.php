 ...
 */
final class Version20240607105452 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE booking (id UUID NOT NULL, company_service_id UUID NOT NULL, client_id UUID NOT NULL, employee_id UUID DEFAULT NULL, start_date VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
