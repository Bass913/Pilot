 ...
 */
final class Version20240605123637 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE booking (id UUID NOT NULL, company_service_id UUID NOT NULL, client_id UUID NOT NULL, start_date VARCHAR(255) NOT NULL, end_date VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE company (id UUID NOT NULL, speciality_id UUID DEFAULT NULL, name VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, zipcode VARCHAR(10) NOT NULL, city VARCHAR(255) NOT NULL, kbis VARCHAR(255) NOT NULL, active BOOLEAN NOT NULL, longitude NUMERIC(11, 8) DEFAULT NULL, latitude NUMERIC(10, 8) DEFAULT NULL, review_rating DOUBLE PRECISION DEFAULT NULL, review_count INT DEFAULT NULL, images TEXT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE company_services (id UUID NOT NULL, company_id UUID DEFAULT NULL, service_id UUID NOT NULL, price NUMERIC(10, 2) NOT NULL, duration INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('COMMENT ON COLUMN company_services.id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN company_services.company_id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN company_services.service_id IS \'(DC2Type:uuid)\'');
        ...
        $this->addSql('CREATE TABLE review (id UUID NOT NULL, company_id UUID DEFAULT NULL, date VARCHAR(255) NOT NULL, comment TEXT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE schedule (id UUID NOT NULL, company_id UUID DEFAULT NULL, user_id_id UUID DEFAULT NULL, day_of_week VARCHAR(9) NOT NULL, start_time TIME(0) WITHOUT TIME ZONE DEFAULT NULL, end_time TIME(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('COMMENT ON COLUMN schedule.user_id_id IS \'(DC2Type:uuid)\'');
        $this->addSql('CREATE TABLE services (id UUID NOT NULL, speciality_id UUID NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('COMMENT ON COLUMN services.speciality_id IS \'(DC2Type:uuid)\'');
        ...
        $this->addSql('CREATE TABLE "user" (id UUID NOT NULL, company_id UUID DEFAULT NULL, firstname VARCHAR(50) NOT NULL, lastname VARCHAR(50) NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, phone VARCHAR(20) DEFAULT NULL, PRIMARY KEY(id))');
